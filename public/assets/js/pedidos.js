const saboresPrecosPequena = {
    "MargueRitaNoMi": 35.00,
    "CheeSeNoMi": 30.00,
    "VegVegNoMi": 29.00,
    "PePeroNoMi": 42.00
};

const saboresPrecosMedia = {
    "MargueRitaNoMi": 45.00,
    "CheeSeNoMi": 40.00,
    "VegVegNoMi": 39.00,
    "PePeroNoMi": 52.00
};

const saboresPrecosGrande = {
    "MargueRitaNoMi": 55.00,
    "CheeSeNoMi": 50.00,
    "VegVegNoMi": 59.00,
    "PePeroNoMi": 62.00
};

const saboresPrecosFamilia = {
    "MargueRitaNoMi": 65.00,
    "CheeSeNoMi": 60.00,
    "VegVegNoMi": 69.00,
    "PePeroNoMi": 72.00
};
...
function tamanho(tam) { //pega o tamanho da pizza
    var tamanho = tam;
    ...
    Select(qtdSabores, tamanho);
}


function Select(num, tam) { //pega a quantidade de sabores da pizza e o tamanho
    ...
    atualizaValores(num, tam);

}

function atualizaValores(qtdSabores, tamanho) {
    var saboresPrecos;

    if (tamanho === "Pequena") {
        saboresPrecos = saboresPrecosPequena;
    } else if (tamanho === "Média") {
        saboresPrecos = saboresPrecosMedia;
    } else if (tamanho === "Grande") {
        saboresPrecos = saboresPrecosGrande;
    } else if (tamanho === "Família") {
        saboresPrecos = saboresPrecosFamilia;
    }

    // Atualiza os valores dos options com base nos preços
    for (let i = 1; i <= 4; i++) {
        const option = document.getElementById(`sabor${i}`);
        const sabor = option.value;
        const preco = saboresPrecos[sabor] / parseInt(qtdSabores);
        option.text = `${sabor} - R$ ${preco.toFixed(2)}`;
    }
}
