    ...
    btn.addEventListener("click", function(){
      ...
      if(limiter.length == 4){
        ...
        senha.style.borderColor = "red"
          ...
          setTimeout(function() {
            senha.style.borderColor = "#568f02"; // Define a cor da borda de volta para transparente após 1 segundo
          }, 2500);
      ...
      btn.addEventListener("click", function(){
        if(senhaconfirm.value != senha.value){
          ...
          setTimeout(function() {
            senhaconfirm.style.borderColor = "#568f02"; // Define a cor da borda de volta para transparente após 1 segundo
          }, 2500);
