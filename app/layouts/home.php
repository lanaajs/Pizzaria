			...
			<div class="menu-content">
				<div class="row">
					...
					<div class="menu-text">
						...
						<div class="menu-right">
							<h5>à partir de R$37.90</h5>
						</div>
					</div>
					<p>Molho especial do Sanji, tomates frescos, queijo mussarela e manjericão.</p>
					<div class="star">
				...
				<div class="row">
					...
					<div class="menu-text">
						...
						<div class="menu-right">
							<h5>à partir de R$28.80</h5>
						</div>
					</div>
					<p>Molho especial do Sanji, queijo mussarela, queijo prato e queijo suíço.</p>
					<div class="star">
						<a href="#"><i class='bx bxs-star' ></i></a>
						<a href="#"><i class='bx bxs-star' ></i></a>
						<a href="#"><i class='bx bxs-star' ></i></a>
				...
				<div class="row">
					...
					<div class="menu-text">
						...
						<div class="menu-right">
							<h5>à partir de R$40.50</h5>
						</div>
					</div>
					<p>Molho especial do Sanji, queijo mussarela, tomate, azeitona, shimeji e manjericão.</p>
					<div class="star">
						<a href="#"><i class='bx bxs-star' ></i></a>
						<a href="#"><i class='bx bxs-star' ></i></a>
						<a href="#"><i class='bx bxs-star' ></i></a>
				...
				<div class="row">
					...
					<div class="menu-text">
						...
						<div class="menu-right">
							<h5>à partir de R$43.00</h5>
						</div>
					</div>
					<p>Molho especial do Sanji, queijo mussarela, pepperoni italiano e azeite de oliva.</p>
					<div class="star">
						<a href="#"><i class='bx bxs-star' ></i></a>
						<a href="#"><i class='bx bxs-star' ></i></a>
						<a href="#"><i class='bx bxs-star' ></i></a>
